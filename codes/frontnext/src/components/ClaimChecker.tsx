    ...
    <>
      ...
      <div className="mx-auto w-full max-w-[760px] px-6 py-16">
        <header className="mb-10">
          ...
          <h1 className="text-display mb-3">{dict.claims.heading}</h1>
          <p className="text-body-lg max-w-[62ch] text-[color:var(--color-ink-600)]">
            {dict.claims.lede}
          </p>
        </header>
        ...
        <section className="border border-[color:var(--color-line)] bg-[color:var(--color-surface)] p-5">
          ...
          <div className="mt-6 border-t border-[color:var(--color-line)] pt-5">
            <h2 className="text-body-sm mb-3 font-medium">{dict.claims.sourceLabel}</h2>
            ...
            <label className="mt-4 block">
              <span className="text-caption mb-1 block text-[color:var(--color-ink-600)]">
            ...
            <p className="text-caption mt-1 max-w-[62ch] text-[color:var(--color-ink-600)]">
        ...
        {result ? (
          <section className="mt-8 border border-[color:var(--color-line)] bg-[color:var(--color-surface)] p-5">
            ...
            {result.check.question_for_author ? (
              <section className="mb-4">
                <h3 className="text-caption mb-1 font-medium">{dict.claims.question}</h3>
                <p className="text-body-sm font-[family-name:var(--font-serif)]">
                  {result.check.question_for_author}
                </p>
              </section>
        ...
        <p className="text-caption mt-8 max-w-[62ch] text-[color:var(--color-ink-400)]">
